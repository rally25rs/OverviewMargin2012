OverviewMargin2012 is an update of the AllMargins suite of VisualStudio plugins,
originally written by David Pugh. This repository is a restructuring of the files
and an update to VisualStudio 2012.

It is distributed under the MS-PL license (included in this repository in text form).
...
Options:
    See: http://dotnetdust.blogspot.com/2010/04/how-to-configure-allmargins-extension.html
    Settings are located in registry at: \HKEY_CURRENT_USER\Software\Microsoft\VisualStudio\10.0\Text Editor

Notes:
    You must install the VisualStudio 2012 SDK before opening this project, or else it will refuse to load.
    The original VisualStudio 2010 source for this extension is at http://code.msdn.microsoft.com/OverviewMargin/Release/ProjectReleases.aspx?ReleaseId=3957